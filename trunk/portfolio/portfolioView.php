...
<div class="container">
  <div class="header">
  <img src="img/logo.png" alt="Insert Logo Here" name="Insert_logo" width="180" height="160" id="Insert_logo" style="background:none;" />
  <!--button one-->
...
<?
	...
	$convDate = strtotime($row["entryDate"]);
		...
		echo '<div id="portfolioText">'.$row["entryText"].'<br /><br />'."\n";
		...
		if ($row["entryPhoto4"] != '') echo '<img src="'.$row["entryPhoto4"].'"><br /><br />'."\n";
	   	echo '<br />';
		echo '<a class="entryTitle" href="portfolio.php">Return to Portfolio page?</a>&nbsp;&nbsp;'."\n";
	   	if ($type == "admin")
		{
			echo "<a class='entryTitle' href='updatePortfolioForm.php?idEntry=". $idEntry ."'>";
			echo 'Edit/Delete this portfolio entry?</a>'."\n";
		}
		echo '<br /><br />';
	?>
	</div><br />
