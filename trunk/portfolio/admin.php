...
<title>Web Designer Brian Beloat - Administration</title>
...
<div class="container">
  ...
  <div class="content">
	...
	while ($row = mysql_fetch_assoc($result)) {
		echo '<div id="portfolioTitle">'."\n".'<b>Client ID: '.$row["idUser"]." - Username: " .$row["userName"]." - First Name: " . $row["userFirstName"] . "</b></br></div>"."\n";
		echo '<div id="portfolioText"><b>Email: </b>'. $row["userEmail"]."\n";
		echo '&nbsp;&nbsp;<b>Phone: </b>'. $row["userPhone"]."\n";
 	    if ($row["userType"] == '1') echo '&nbsp;&nbsp;<b>UserType:</b> Admin<br />'."\n";
		if ($row["userType"] == '2') echo '&nbsp;&nbsp;<b>UserType:</b> User<br />'."\n";
	   	echo '</div><br />';
	}
	//end .content
