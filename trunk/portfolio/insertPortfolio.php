  ...
  <div class="content">
		<div id="jobText">
  		<?php
			...
			$sql = "INSERT INTO Portfolio(User_idUser,entryDate,entryTitle,entryText,entryPhoto1,entryPhoto2,entryPhoto3,entryPhoto4) VALUES (1,'$entryDate','$entryTitle','$entryText','$entryPhoto1','$entryPhoto2','$entryPhoto3','$entryPhoto4')";
