...
<title>Web Designer Brian Beloat - Update Account Info</title>
...
?>
<div id="jobText">
<b>Update Account Information</b><br /><br />
<form id="userForm" action="updateAccount.php" method="post">
<input id="idUser" name="idUser" value="<? echo $row["idUser"]; ?>" type="hidden" />
<p>
<label for="userName">User Name (cannot be changed)</label>
<input type="text" disabled="disabled" name="userName" value="<? echo $row["userName"]; ?>">
</p>
<p>
<label for="userPW">Password</label>
<input type="password" name="userPW" id="userPW" value="<? echo $row["userPW"]; ?>">
</p>
<p>
<label for="userFirstName">First Name</label>
<input name="userFirstName" id="userFirstName" value="<? echo $row["userFirstName"]; ?>" class="required">
</p>
<p>
<label for="userEmail">Email</label>
<input type="text" name="userEmail" id="userEmail" value="<? echo $row["userEmail"]; ?>">
</p>
<p>
<label for="userPhone">Phone Number</label>
<input name="userPhone" id="userPhone" value="<? echo $row["userPhone"]; ?>">
</p>
<p>
