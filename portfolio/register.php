...
<title>Web Designer Brian Beloat - Register</title>
...
<div class="container">
  ...
  <div class="content">
    ...
    <form id="userForm" action="registerProcess.php" method="post">
		<p>
		<label for="Title">Username (this cannot be changed)</label>
		<input name="userName" id="userName" class="required">
		</p>
		<p>
		<label for="Title">Select Password</label>
		<input type="password" name="userPW" id="userPW" class="required">
		</p>
		<p>
		<label for="Title">Confirm Password</label>
		<input type="password" name="userPW2" id="userPW2" class="required">
		</p>
		<p>
		<label for="Title">First Name</label>
		<input name="userFirstName" id="userFirstName" class="required">
		</p>
		<p>
		<label for="Title">Email</label>
		<input name="userEmail" id="userEmail" class="required">
		</p>
		<p>
		<label for="Title">Phone</label>
		<input name="userPhone" id="userPhone" class="required">
		</p>
		<p>
