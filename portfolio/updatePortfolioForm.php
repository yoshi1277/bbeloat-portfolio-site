...
<title>Web Designer Brian Beloat - Update Portfolio</title>
...
<div class="container">
  ...
  <div class="content">
		<?
			$idEntry = mysql_real_escape_string($_GET["idEntry"]);
			$sql = "SELECT * FROM Portfolio WHERE idEntry='$idEntry'";
		...
		<div id="portfolioText">
			<b>Update/Delete Portfolio Entry</b><br /><br />
			<form id="portfolioForm" action="updatePortfolio.php" method="post">
			<input id="idEntry" name="idEntry" value="<? echo $row["idEntry"]; ?>" type="hidden" />
			<p>
			<label for="Title">Title</label>
			<input name="entryTitle" id="entryTitle" value="<? echo $row["entryTitle"]; ?>" class="required">
			</p>
			<p>
			<label for="entryText">Text</label>
			<textarea cols=100 rows=10 name="entryText" id="entryText">
			<? echo $row["entryText"]; ?>
			</textarea>
			</p>
			<p>
			<label for="entryPhoto1">Photo URL 1</label>
			<input name="entryPhoto1" id="entryPhoto1" value="<? echo $row["entryPhoto1"]; ?>">
			</p>
			<p>
			<label for="entryPhoto2">Photo URL 2</label>
			<input name="entryPhoto2" id="entryPhoto2" value="<? echo $row["entryPhoto2"]; ?>">
			</p>
			<p>
			<label for="entryPhoto3">Photo URL 3</label>
			<input name="entryPhoto3" id="entryPhoto3" value="<? echo $row["entryPhoto3"]; ?>">
			</p>
			<p>
			<label for="entryPhoto4">Photo URL 4</label>
			<input name="entryPhoto4" id="entryPhoto4" value="<? echo $row["entryPhoto4"]; ?>">
			</p>
			<p>
