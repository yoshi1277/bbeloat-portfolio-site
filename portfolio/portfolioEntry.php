...
<title>Web Designer Brian Beloat - Portfolio Entry</title>
...
<div class="container">
  ...
  <div class="content">
    ...
    <b>Insert New Portfolio Entry</b><br /><br />
    <form id="formPortfolioInsert" action="insertPortfolio.php" method="post">
			<p>
			<label for="Title">Title</label>
			<input name="entryTitle" id="entryTitle" class="required">
			</p>
			<p>
			<label for="entryText">Text</label>
			<textarea cols=100 rows=10 name="entryText" id="entryText" ></textarea>
			</p>
			<p>
			<label for="entryPhoto1">Photo URL 1</label>
			<input name="entryPhoto1" id="entryPhoto1">
			</p>
			<p>
			<label for="entryPhoto2">Photo URL 2</label>
			<input name="entryPhoto2" id="entryPhoto2">
			</p>
			<p>
			<label for="entryPhoto3">Photo URL 3</label>
			<input name="entryPhoto3" id="entryPhoto3">
			</p>
			<p>
			<label for="entryPhoto4">Photo URL 4</label>
			<input name="entryPhoto4" id="entryPhoto4">
			</p>
			<p>
